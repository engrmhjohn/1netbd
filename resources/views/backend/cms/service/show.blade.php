...
<div class="row">
    <div class="col-lg-12">
        <div class="card">
            ...
            <div class="card-body">
                <a href="{{ route('admin.manage_service') }}" class="btn btn-sm btn-success" title="Add New">
                    Manage Service
                </a>
                <form action="{{ route('admin.save_service') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 mb-3">
                            <div class="form-group">
                                ...
                                <input class="form-control" name="en_button_text" type="text" required>
                            </div>
                        </div>
                        <div class="col-lg-3 mb-3">
                            <div class="form-group">
                                <label for="button_link">Button Link</label>
                                <input class="form-control" name="button_link" type="text" required>
                            </div>
                        </div>
