...
<div class="row">
    <div class="col-lg-12">
        <div class="card">
            ...
            <div class="card-body">
                <a href="{{ route('admin.manage_vision') }}" class="btn btn-sm btn-success" title="Add New">
                    Manage Vision
                </a>
                <form action="{{ route('admin.save_vision') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
