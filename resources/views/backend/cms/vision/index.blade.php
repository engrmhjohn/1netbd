    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <a href="{{ route('admin.add_vision') }}" class="btn btn-success btn-sm" title="Add New">
