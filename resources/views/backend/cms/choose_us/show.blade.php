...
<div class="row">
    <div class="col-lg-12">
        <div class="card">
            ...
            <div class="card-body">
                <a href="{{ route('admin.manage_choose_us') }}" class="btn btn-sm btn-success" title="Add New">
                    Manage Choose Us
                </a>
                <form action="{{ route('admin.save_choose_us') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
