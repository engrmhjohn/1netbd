...
<div class="row">
    <div class="col-lg-12">
        <div class="card">
            ...
            <div class="card-body">
                <a href="{{ route('admin.manage_testimonial') }}" class="btn btn-sm btn-success" title="Add New">
                    Manage Testimonial
                </a>
                <form action="{{ route('admin.save_testimonial') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        ...
                        <div class="col-lg-4 mb-3">
                            <div class="form-group">
                                ...
                                <input class="form-control" name="en_designation" type="text" required>
                            </div>
                        </div>
