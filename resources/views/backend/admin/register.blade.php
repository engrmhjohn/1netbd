                                    ...
                                    <div class="tab-content">
                                        <div class="tab-pane active" id="tab5">
                                            <div class="wrap-input100 validate-input input-group"
                                                data-bs-validate="Valid name is required: ex@abc.xyz">
                                                ...
                                                <input class="input100 border-start-0 form-control ms-0" type="text"
                                                    placeholder="Name" name="name" :value="old('name')" required autofocus autocomplete="name">
                                            </div>
                                            <div class="wrap-input100 validate-input input-group"
                                            ...
                                            <div class="wrap-input100 validate-input input-group"
                                                ...
                                                <input class="input100 border-start-0 form-control ms-0" type="text"
                                                    placeholder="Phone" type="text" name="phone" :value="old('phone')" required autofocus autocomplete="phone">
                                            </div>
                                            <div class="wrap-input100 validate-input input-group"
                                                ...
                                                <input class="input100 border-start-0 form-control ms-0" type="text"
                                                    placeholder="Email" type="email" name="email" :value="old('email')" required autocomplete="email">
                                            </div>
