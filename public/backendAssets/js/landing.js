(function ($) {
  ...
  $(".testimonial-carousel").slick({
    ...
    arrows: true,
    dots: false,
    nextArrow: '<span class="slick_right"><img src="backendAssets/static_images/next.png"></span>',
    prevArrow: '<span class="slick_left"><img src="backendAssets/static_images/prev.png"></span>',
    pauseOnHover: false,
    responsive: [
      {
        breakpoint: 768,
